...
exports.getBookingDetailsById = exports.cancelBookingController = exports.getUserBookingDetailsController = exports.findAllBookingController = exports.createBookingController = void 0;
const bookingModal_1 = require("../Modal/bookingModal");
...
const nodeMailer_1 = require("../userRegisterOtpVerify/nodeMailer");
const createBookingController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { categoryId, vehicleId } = req.params;
        const { licenseNo, bookingDate, returnDate, price, pickuplocation, droplocation, paymentMethod, } = req.body;
        ...
        const loginData = yield req.cookies["refresh_token"];
        if (!loginData) {
            res.status(401).json({
        ...
        const getUser = yield (0, loginModal_1.checkformRefreshToken)(loginData);
        const useremail = String(getUser === null || getUser === void 0 ? void 0 : getUser.email);
        const vechId = Number(vehicleId);
        const vech = yield (0, bookingModal_1.getVehicleForBooking)(vechId);
        if ((vech === null || vech === void 0 ? void 0 : vech.status) !== "AVAILABLE") {
            res.status(400).json({
                message: "Not available for booking ",
            });
        }
        const vehicleName = String(vech === null || vech === void 0 ? void 0 : vech.name);
        console.log("This is the vehicle name ", vehicleName);
        const categId = Number(categoryId);
        const catName = yield (0, categoryModal_1.getCategoryById)(categId);
        const categoryName = String(catName === null || catName === void 0 ? void 0 : catName.name);
        // getting user name
        const findUserName = yield (0, userModal_1.getUserByEmail)(useremail);
        const username = String(findUserName === null || findUserName === void 0 ? void 0 : findUserName.username);
        const initiate = yield (0, bookingModal_1.createBooking)({
            useremail,
            licenseImg,
            licenseNo,
            vechId,
        ...
        yield (0, nodeMailer_1.sendMail)(useremail, "Renting details", `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
const findAllBookingController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const getUser = yield (0, loginModal_1.checkformRefreshToken)(loginData);
        if ((getUser === null || getUser === void 0 ? void 0 : getUser.role) !== "admin") {
            res.status(401).json({
                message: "You are not admin",
            });
            return;
        }
        const getBooking = yield (0, bookingModal_1.getAllBookingModal)();
        if (!getBooking) {
            res.status(400).json({
...
exports.findAllBookingController = findAllBookingController;
// get booking details to specific user
const getUserBookingDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const loginData = yield req.cookies["refresh_token"];
        if (!loginData) {
            res.status(401).json({
        ...
        const getUser = yield (0, loginModal_1.checkformRefreshToken)(loginData);
        const email = String(getUser === null || getUser === void 0 ? void 0 : getUser.email);
        const getUserBooking = yield (0, bookingModal_1.getUserBookingModal)(email);
        if (!getUserBooking) {
...
exports.getUserBookingDetailsController = getUserBookingDetailsController;
const getBookingDetailsById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { bookingId } = req.params;
        const bookId = Number(bookingId);
        const getBookingDetail = yield (0, bookingModal_1.getBookingDetailByIdModal)(bookId);
        if (!getBookingDetail) {
            res.status(400).json({
...
const cancelBookingController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const getBookingDetailsById = yield (0, bookingModal_1.getBookingDetailByIdModal)(bookingID);
        const vehicleId = Number(getBookingDetailsById === null || getBookingDetailsById === void 0 ? void 0 : getBookingDetailsById.vehicleId);
        // call modal
        const cancelResult = yield (0, bookingModal_1.cancelBookingModal)(bookingID, vehicleId);
        res.status(200).json({
            message: "Booking cancelled successfully",
        });
        yield (0, nodeMailer_1.sendMail)(useremail, "Booking Cancellation", `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <h2>Dear ${getBookingDetailsById === null || getBookingDetailsById === void 0 ? void 0 : getBookingDetailsById.username} ,</h2>
            ...
            <div class="booking-details">
                ...
                <div class="detail-row">
                    <span class="detail-label">Vehicle:${getBookingDetailsById === null || getBookingDetailsById === void 0 ? void 0 : getBookingDetailsById.vehicleName}</span>
             
                </div>
                <div class="detail-row">
                    <span class="detail-label">Booked for:</span>
                    <span class="detail-value">${getBookingDetailsById === null || getBookingDetailsById === void 0 ? void 0 : getBookingDetailsById.bookingDate}</span>
                </div>
                <div class="detail-row">
            ...
            <div class="refund-info">
                ...
                <p>Based on our cancellation policy, a refund of <strong>${getBookingDetailsById === null || getBookingDetailsById === void 0 ? void 0 : getBookingDetailsById.price}</strong> will be processed to your original payment method.</p>
