...
exports.resetPasswordService = {
    sendOtp(email, session) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, nodeMailer_1.sendMail)(email, "Password Reset OTP", ` <title>Password Reset OTP</title>
    <style>
...
<body>
    ...
    resetPassword(newPassword, session) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!session.resetEmail)
                throw new Error("Session expired");
